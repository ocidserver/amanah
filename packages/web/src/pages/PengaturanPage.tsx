...
import { IconShield, IconMail, IconLogOut, IconChevronLeft, IconChevronRight } from "../components/Icons"
...
function SettingItem({ icon, label, subtitle, onClick, danger }: {
  ...
  return (
    ...
    >
      ...
      {onClick && !danger && <IconChevronRight className="w-4 h-4 text-gray-300" />}
    </button>
  )
}
...
export default function PengaturanPage() {
  ...
  return (
    <div className="px-4 pt-4 pb-6">
      ...
      <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden mb-4">
        <div className="px-4 py-3 bg-gray-50 border-b border-gray-100">
          <p className="text-xs font-semibold text-gray-400 uppercase tracking-wider">Preferensi</p>
        </div>
        <SettingItem
          icon={
          ...
          label="Notifikasi"
          subtitle="Pengingat cicilan & pembaruan"
        />
        <div className="h-px bg-gray-100 ml-12" />
        <SettingItem
          icon={
        ...
        <SettingItem
          ...
          label="Privasi"
          subtitle="Pengaturan data & privasi"
        />
      </div>
