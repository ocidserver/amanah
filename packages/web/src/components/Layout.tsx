...
export default function Layout() {
  ...
  const navItems = [
    ...
    { to: "/pinjaman", label: t("nav.loans"), Icon: IconLoan },
    { to: "/wali-amanah", label: t("nav.trustee"), Icon: IconTrustee },
    { to: "/profil", label: t("nav.profile"), Icon: IconUser },
  ]
    ...
    <div className="min-h-dvh bg-gray-50 dark:bg-slate-900 flex flex-col">
      ...
      <header className="bg-[var(--color-primary)] text-white px-4 py-3 flex items-center justify-between sticky top-0 z-40 safe-top">
        ...
        <div className="flex items-center gap-3">
          ...
          <span className="text-xs opacity-70">{t("app.tagline")}</span>
        </div>
      </header>
