...
export default function TrusteeLayout() {
  ...
  return (
    <div className="min-h-dvh bg-gray-50 dark:bg-slate-900 flex flex-col">
      ...
      <nav className="fixed bottom-0 inset-x-0 bg-white dark:bg-slate-800 dark:border-slate-700 border-t border-gray-100 z-40 safe-bottom" role="navigation" aria-label="Navigasi wali amanah">
